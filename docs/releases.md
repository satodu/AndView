...
AndView doesn't have built-in auto-update functionality. To update:

1. Download the latest AppImage from this page
2. Replace your old AppImage with the new one
3. Run the new version

## 📱 System Requirements

- **OS:** Linux (Ubuntu, Fedora, Arch, openSUSE, etc.)
...
Having issues? Check our [Troubleshooting Guide]({{ '/troubleshooting' | relative_url }}) or [create an issue](https://github.com/satodu/AndView/issues).
